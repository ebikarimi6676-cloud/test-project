...
class ValidationError(Exception):
    """خطاهای اعتبارسنجی ورودی‌ها."""
    pass


class TestCase:
    def init(self, test_name: str, test_log: str,
                 subtests: list = None,
    ...
    def validate_test_log(self, log: str) -> str:
    ...
    def run_test(self):
        ...
        try:
            ...
            # اینجا یک منطق تست ساده قرار می‌دهیم (برای نمونه)
